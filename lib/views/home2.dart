...
class _TaskListPageState2 extends State<TaskListPage2> {
  ...
  final List<Map<String, String>> recommendedTasks = [
    {
      'title': 'الذهاب للعمل',
      'description': 'يجب الذهاب للعمل في الوقت المحدد'
    },
    {
      'title': 'go to the gym',
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height:
                  150, // Adjust height based on the number of tasks to display at a time
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                itemCount: items.length,
                itemBuilder: (context, index) {
                  final item = items[index] as Map;
                  return _buildTaskCard(Text(item['title']) as String,
                ...
                MaterialButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RecommendedTasksPageAI(
                                  token: '',
                                )));
                  },
                  minWidth: 153,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  FilterChip(
                    label: Column(
                      children: [Text('Daily'), Text('Routine')],
                    ),
                    onSelected: (bool selected) {},
                  ),
                ],
              ...
              child: MaterialButton(
                onPressed: () {
                  ...
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => AddTaskPage2()));
                },
                minWidth: 130,
                height: 47,
                color: Colors.black,
  ...
  void navigateToAddPage() {
    final route = MaterialPageRoute(builder: (context) => AddTaskPage2());
